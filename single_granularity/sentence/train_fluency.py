...
def build_prompt(transcript: str) -> str:
    return (
        ...
        "Rubric:\n"
        "- Excellent:Coherent speech, without noticeable pauses, repetition or stammering.\n"
        "- Good:  Coherent speech in general, with a few pauses, repetition and stammering.\n"
        "- Average:  The speech is incoherent, with many pauses, repetition and stammering.\n"
        "- Bad: The speaker is not able to read the sentence as a whole or there is no voice.\n"
        f"Transcript: \"{transcript}\"\n"
        "Assign one label (Excellent, Good, Average, Bad).\n"
        "Verdict:"
    )
