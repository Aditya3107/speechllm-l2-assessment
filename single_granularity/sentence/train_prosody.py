...
def build_prompt(transcript: str) -> str:
    return (
        ...
        "Rubric:\n"
        "- Excellent: Correct intonation, stable speaking speed and rhythm. \n"
        "- Good: Nearly correct intonation at a stable speaking speed. \n"
        "- Average: Unstable speech speed, or the intonation is inappropriate. \n"
        "- Bad: The reading of the sentence is too stammering to do prosodic scoring or there is no voice. \n"
